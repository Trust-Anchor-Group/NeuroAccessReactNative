  ...
  <View {...restProps}>
    ...
    >
      ...
      <G
        x={moderateScale(50)}
        y={moderateScale(217)}
        filter="url(#filter0_b_1528_19523)"
      >
        {insideView(restProps.scanAreaCornerBg)}
      </G>
    </Svg>
  </View>
);

const insideView = (scanAreaCornerBg: ColorValue | undefined) => {
  return (
    <Svg
      x={moderateScale(50)}
      y={moderateScale(217)}
