export const Colors = {
  light: {
    ...
    inputBox: {
      ...
      activeText: '#181F25',
      inactiveText: 'rgba(24, 31, 37, 0.5)',
      leftIconDefault: 'rgba(24, 31, 37, 0.5)',
      leftIconActive: '#3E776D',
    },
    text: {
      primary: '#181F25',
      error: '#F2495C',
    ...
    choosePurpose: {
      ...
      itemSelectedBg: '#181F25',
      itemBorder: 'rgba(24, 31, 37, 0.5)',
    ...
    currentProvider: {
      ...
      borderColor: 'rgba(24, 31, 37, 1)',
      unSelectedBorder: 'rgba(24, 31, 37, 0.5)',
      defaultBgColor: 'rgba(245, 246, 247, 1)',
      selectedBgColor: 'rgba(24, 31, 37, 1)',
      unSelectedBgColor: 'rgba(245, 246, 247, 1)',
      titleColor: 'rgba(24, 31, 37, 1)',
  ...
  dark: {
    ...
    inputBox: {
      ...
      leftIconDefault: 'rgba(255, 255, 255, 0.3)',
      leftIconActive: '#50998C',
    },
    text: {
    ...
    currentProvider: {
      ...
      defaultBgColor: 'rgba(62, 62, 64, 1)',
      selectedBgColor: 'rgba(224, 228, 231, 1)',
      unSelectedBgColor: 'rgba(22, 22, 23, 1)',
